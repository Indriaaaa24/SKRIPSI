          ...
          <form action="<?= base_url('order') ?>" enctype="multipart/form-data" method="post" autocomplete="off">
            ...
            <div class="card-body">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Silahkan Transfer ke Nomor Rekening ini Sesuai Total Harga</li>
                <li class="list-group-item">Nomor Rekening: <b>216601010344509 (BRI)</b></li>
              </ul>

              <div class="form-group">
                <input type="hidden" name="user" value="<?= user()->id ?>" class="form-control" required>
              </div>
              ...
              <div class="form-group">
                <input type="hidden" name="harga" class="form-control" required id="harga_hidden">
              </div>
              <div class="form-group">
    ...
    $('document').ready(function() {
      ...
      $("#payment").on('change', function() {
        ...
        if (payment_method === "DP") {
          total_harga = harga * 0.5; // 50% off
        } 
        $("#harga_hidden").val(total_harga);
