      ...
      <div class="card card-primary card-tabs">
        <div class="card-header p-0 pt-1">
          <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#custom-tabs-two-home" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true">Pesanan</a>
            </li>
            <li class="nav-item">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right"> Keterangan : <?= $value->payment ?><br>
                    Harga : <?= number_to_currency($value->harga ,'IDR'); ?> <br>
                    <hr>
                    <b>Total : <?= number_to_currency($value->harga ,'IDR'); ?></b></td>
                    <td>
