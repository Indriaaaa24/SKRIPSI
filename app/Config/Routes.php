...
$routes->get('/category/(:any)', 'Home::category_detail/$1', ['as' => 'category_detail']);
$routes->get('/product', 'Home::product', ['as' => 'products']);
$routes->get('/cart', 'Home::cart', ['as' => 'cart', 'filter' => 'login']);
$routes->get('add-cart/(:num)', 'Home::add_cart/$1', ['as' => 'add_cart' , 'filter' => 'login']);
$routes->get('about', 'Home::about');


$routes->post('post-cart', 'Home::post_cart', ['as' => 'post_cart', 'filter' => 'login']);
$routes->get('checkout', 'Home::checkout', ['as' => 'checkout', 'filter' => 'login']);
...
$routes->get('/home/delete/(:any)', 'Home::delete/$1', ['as' => 'delete_cart']);
...
$routes->post('order', 'Order::save', ['filter' => 'login']);
$routes->put('kategori/(:any)', 'Kategori::update/$1', ['filter' => 'role:admin, superadmin']);
$routes->get('detail-product/(:any)', 'Product::details/$1');
$routes->get('kategori/(:any)', 'Kategori::edit/$1', ['filter' => 'role:admin, superadmin']);
$routes->get('kategori-hapus/(:segment)', 'Kategori::destroy/$1', ['filter' => 'role:superadmin, admin']);
